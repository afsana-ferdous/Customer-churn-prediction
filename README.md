...
## Key Results
- **AUC score: 0.81**
- Model effectively distinguishes between high-risk and low-risk customers
- Enables practical prioritisation of retention actions
...
Outputs from this analysis can support:
...
## Notes
This project was completed as part of an academic analytics programme and is intended to demonstrate applied data analytics and predictive modelling skills in a business context.  
The structure and approach reflect real-world churn analysis used in commercial environments.
